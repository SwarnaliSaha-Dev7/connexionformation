                ...
                <div class="col-12 col-lg-5">
                    <aside class="footer__aside">
                        <a class="footer__brand" href="#">
                            <img src="{{ asset('assets/images/logo.svg') }}" alt="logo" width="200px" height="50px" loading="lazy"
                                fetchpriority="auto">
                        </a>
                        ...
                        <div class="footer__top">
                            ...
                            <form class="footer__subscribe">
                                ...
                                <button class="footer__send" type="submit" aria-label="Send">
                                    <img src="{{ asset('assets/images/mail-arr.svg') }}" alt="mail arrow" width="15px" height="14px"
                        ...
                        <div class="footer__links">
                            ...
                            <section class="footer__group">
                                ...
                                <ul class="footer__link_page">
                                    <li><a href="#"><img src="{{ asset('assets/images/facebook.svg') }}" alt="Instagram Image" height="12"
                                                width="6" loading="lazy" fetchpriority="auto"></a></li>
                                    <li><a href="#"><img src="{{ asset('assets/images/insta.svg') }}" alt="Instagram Image" height="12"
                                                width="12" loading="lazy" fetchpriority="auto"></a></li>
                                    <li><a href="#"><img src="{{ asset('assets/images/tictok.svg') }}" alt="Instagram Image" height="12"
